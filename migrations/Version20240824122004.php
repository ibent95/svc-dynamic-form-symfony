...
final class Version20240824122004 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dynamic_form_field_type (id BIGINT UNSIGNED NOT NULL, dynamic_form_field_type_code VARCHAR(255) DEFAULT NULL, dynamic_form_field_type VARCHAR(255) DEFAULT NULL, dynamic_form_field_configs JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', dynamic_form_field_validation_configs JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', description LONGTEXT DEFAULT NULL, flag_active TINYINT(1) DEFAULT 1 NOT NULL, create_user VARCHAR(50) DEFAULT \'system\' NOT NULL, created_at DATETIME NOT NULL, update_user VARCHAR(50) DEFAULT \'system\' NOT NULL, updated_at DATETIME NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }

 ...
 */
final class Version20230907233347 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE publication (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, id_publication_general_type BIGINT UNSIGNED DEFAULT NULL, id_publication_type BIGINT UNSIGNED DEFAULT NULL, id_publication_form_version BIGINT UNSIGNED DEFAULT NULL, id_publication_status BIGINT UNSIGNED DEFAULT NULL, title VARCHAR(500) DEFAULT NULL, publication_date DATETIME DEFAULT NULL, flag_active TINYINT(1) DEFAULT 1 NOT NULL, created_user VARCHAR(50) DEFAULT NULL, created_at DATETIME NOT NULL, updated_user VARCHAR(50) DEFAULT NULL, updated_at DATETIME NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_AF3C67795ECB64EE (id_publication_general_type), INDEX IDX_AF3C677964AC8335 (id_publication_type), INDEX IDX_AF3C6779A4A6901E (id_publication_form_version), INDEX IDX_AF3C67791CC9C6FE (id_publication_status), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE publication_form (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, id_form_version BIGINT UNSIGNED DEFAULT NULL, id_form_parent BIGINT DEFAULT NULL, field_label VARCHAR(255) DEFAULT NULL, field_type VARCHAR(100) NOT NULL, field_name VARCHAR(100) DEFAULT NULL, field_id VARCHAR(100) NOT NULL, field_class VARCHAR(100) DEFAULT NULL, field_placeholder VARCHAR(255) DEFAULT NULL, field_options VARCHAR(255) DEFAULT NULL, field_configs LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', description VARCHAR(255) DEFAULT NULL, order_position INT DEFAULT NULL, validation_configs LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', error_message VARCHAR(255) DEFAULT NULL, dependency_child LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', dependency_parent LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', flag_required TINYINT(1) DEFAULT 0 NOT NULL, flag_field_publication_type TINYINT(1) DEFAULT 0 NOT NULL, flag_field_title TINYINT(1) DEFAULT 0 NOT NULL, flag_field_publication_date TINYINT(1) DEFAULT 0 NOT NULL, flag_active TINYINT(1) DEFAULT 1 NOT NULL, created_user VARCHAR(50) DEFAULT NULL, created_at DATETIME NOT NULL, updated_user VARCHAR(50) DEFAULT NULL, updated_at DATETIME NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_59707C82ADB1C68A (id_form_version), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE publication_form_version (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, id_publication_type BIGINT UNSIGNED NOT NULL, publication_form_version_name VARCHAR(255) NOT NULL, publication_form_version_code VARCHAR(50) NOT NULL, grid_system LONGTEXT DEFAULT \'{"type":"no_grid_system","cols":12,"config":{}}\' COMMENT \'(DC2Type:json)\', flag_active TINYINT(1) DEFAULT 1 NOT NULL, created_user VARCHAR(50) DEFAULT NULL, created_at DATETIME NOT NULL, updated_user VARCHAR(50) DEFAULT NULL, updated_at DATETIME NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_CFA3AA3D64AC8335 (id_publication_type), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE publication_meta (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, id_publication BIGINT UNSIGNED NOT NULL, field_name VARCHAR(150) NOT NULL, field_value VARCHAR(1000) DEFAULT NULL, flag_active TINYINT(1) DEFAULT 1 NOT NULL, created_user VARCHAR(50) DEFAULT NULL, created_at DATETIME NOT NULL, updated_user VARCHAR(50) DEFAULT NULL, updated_at DATETIME NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_DC0A95F8B72EAA8E (id_publication), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE publication_meta_v2 (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, id_publication BIGINT UNSIGNED NOT NULL, id_form_version BIGINT UNSIGNED DEFAULT NULL, id_form_parent BIGINT UNSIGNED DEFAULT NULL, field_label VARCHAR(255) DEFAULT NULL, field_type VARCHAR(100) NOT NULL, field_name VARCHAR(100) DEFAULT NULL, field_id VARCHAR(100) NOT NULL, field_class VARCHAR(100) DEFAULT NULL, field_placeholder VARCHAR(255) DEFAULT NULL, field_options VARCHAR(255) DEFAULT NULL, field_configs LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', description VARCHAR(255) DEFAULT NULL, order_position INT DEFAULT NULL, validation_configs LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', error_message VARCHAR(255) DEFAULT NULL, dependency_child LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', dependency_parent LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', flag_required TINYINT(1) DEFAULT 0 NOT NULL, flag_field_publication_type TINYINT(1) DEFAULT 0 NOT NULL, flag_field_title TINYINT(1) DEFAULT 0 NOT NULL, flag_field_publication_date TINYINT(1) DEFAULT 0 NOT NULL, value TEXT DEFAULT NULL, flag_active TINYINT(1) DEFAULT 1 NOT NULL, created_user VARCHAR(50) DEFAULT NULL, created_at DATETIME NOT NULL, updated_user VARCHAR(50) DEFAULT NULL, updated_at DATETIME NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_7E278A9AB72EAA8E (id_publication), INDEX IDX_7E278A9AADB1C68A (id_form_version), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE publication_type (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, id_publication_general_type BIGINT UNSIGNED NOT NULL, publication_type_name VARCHAR(255) NOT NULL, publication_type_code VARCHAR(50) NOT NULL, flag_active TINYINT(1) DEFAULT 1 NOT NULL, created_user VARCHAR(50) DEFAULT NULL, created_at DATETIME NOT NULL, updated_user VARCHAR(50) DEFAULT NULL, updated_at DATETIME NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_8726D6E45ECB64EE (id_publication_general_type), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE publication_meta_v2 ADD CONSTRAINT FK_7E278A9AB72EAA8E FOREIGN KEY (id_publication) REFERENCES publication (id)');
        $this->addSql('ALTER TABLE publication_meta_v2 ADD CONSTRAINT FK_7E278A9AADB1C68A FOREIGN KEY (id_form_version) REFERENCES publication_form_version (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publication_meta_v2 DROP FOREIGN KEY FK_7E278A9AB72EAA8E');
        $this->addSql('ALTER TABLE publication_meta_v2 DROP FOREIGN KEY FK_7E278A9AADB1C68A');
        ...
        $this->addSql('DROP TABLE publication_meta_v2');

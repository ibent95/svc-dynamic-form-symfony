 ...
 */
final class Version20220313145647 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE form (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, publication_form_version_id BIGINT UNSIGNED DEFAULT NULL, id_form_version BIGINT NOT NULL, id_form_parent BIGINT DEFAULT NULL, field_label VARCHAR(255) DEFAULT NULL, field_type VARCHAR(100) NOT NULL, field_name VARCHAR(100) DEFAULT NULL, field_id VARCHAR(100) NOT NULL, field_class VARCHAR(100) DEFAULT NULL, field_placeholder VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, error_message VARCHAR(255) DEFAULT NULL, validation_config VARCHAR(255) DEFAULT NULL, dependency_child LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', dependency_parent LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', flag_required TINYINT(1) DEFAULT 0 NOT NULL, flag_active TINYINT(1) DEFAULT 1 NOT NULL, created_user VARCHAR(50) DEFAULT NULL, created_at DATETIME NOT NULL, updated_user VARCHAR(50) DEFAULT NULL, updated_at DATETIME NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_5288FD4F51C5150D (publication_form_version_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE publication_form_version (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, publication_type_id BIGINT UNSIGNED DEFAULT NULL, publication_form_version_name VARCHAR(255) NOT NULL, publication_form_version_code VARCHAR(50) NOT NULL, flag_active TINYINT(1) DEFAULT 1 NOT NULL, created_user VARCHAR(50) DEFAULT NULL, created_at DATETIME NOT NULL, updated_user VARCHAR(50) DEFAULT NULL, updated_at DATETIME NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_CFA3AA3DCDC55AAF (publication_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE form DROP FOREIGN KEY FK_5288FD4F51C5150D');

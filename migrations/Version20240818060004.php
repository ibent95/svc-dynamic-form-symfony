 ...
 */
final class Version20240818060004 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE publication_meta (id BIGINT UNSIGNED NOT NULL, id_form BIGINT UNSIGNED NOT NULL, id_publication BIGINT UNSIGNED NOT NULL, id_form_version BIGINT UNSIGNED NOT NULL, id_form_parent BIGINT UNSIGNED DEFAULT NULL, field_label VARCHAR(255) DEFAULT NULL, field_type VARCHAR(100) NOT NULL, field_name VARCHAR(100) DEFAULT NULL, field_id VARCHAR(100) NOT NULL, field_class VARCHAR(100) DEFAULT NULL, field_placeholder VARCHAR(255) DEFAULT NULL, field_options VARCHAR(255) DEFAULT NULL, field_configs JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', description VARCHAR(255) DEFAULT NULL, order_position INT DEFAULT NULL, validation_configs JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', error_message VARCHAR(255) DEFAULT NULL, dependency_child JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', dependency_parent JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', flag_required TINYINT(1) DEFAULT 0 NOT NULL, flag_field_form_type TINYINT(1) DEFAULT 0 NOT NULL, flag_field_title TINYINT(1) DEFAULT 0 NOT NULL, flag_field_publish_date TINYINT(1) DEFAULT 0 NOT NULL, value TEXT DEFAULT NULL, other_value JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', flag_active TINYINT(1) DEFAULT 1 NOT NULL, create_user VARCHAR(50) DEFAULT \'system\' NOT NULL, created_at DATETIME NOT NULL, update_user VARCHAR(50) DEFAULT \'system\' NOT NULL, updated_at DATETIME NOT NULL, uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_DC0A95F8D9A8E14D (id_form), INDEX IDX_DC0A95F8B72EAA8E (id_publication), INDEX IDX_DC0A95F8ADB1C68A (id_form_version), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

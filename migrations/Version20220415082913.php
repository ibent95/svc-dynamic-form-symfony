 ...
 */
final class Version20220415082913 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publication_form CHANGE validation_config validation_config LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\'');
    }

 ...
 */
final class Version20220413231358 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publication_form ADD field_configs LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', ADD order_position INT DEFAULT NULL');
    }

...
CREATE TABLE `publication_form` (
  ...
  `validation_config` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '(DC2Type:json)',
...
INSERT INTO `publication_form` VALUES (1,1,1,NULL,'Try text','text','text_1','text_1','text_1','Try text placeholder',NULL,NULL,'Try text description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','39357f6a-52bd-44f3-ba57-49cc143b941a'),(2,1,1,NULL,'Try select','select','select_1','select_1','select_1','Try select placeholder','master-publication_status',NULL,'Try select description',NULL,NULL,NULL,NULL,NULL,0,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','18b1c813-d6a6-444e-a4d1-5848c750ef7a'),(3,1,1,NULL,'Try stepper','stepper',NULL,'try_stepper','try_stepper',NULL,NULL,'{\"orientation\":\"horizontal\",\"linear\":true}',NULL,NULL,NULL,NULL,NULL,NULL,0,1,'system','2022-04-13 08:30:00','system','2022-04-13 08:30:00','950ad242-10d3-4ba7-bbd9-09037575c588'),(4,1,1,3,'Try step 1','step',NULL,'try_step','try_step',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,'system','2022-04-13 08:30:00','system','2022-04-13 08:30:00','b3b89437-a19f-48af-84fa-c77736ef73b6'),(5,1,1,3,'Try step 2','step',NULL,'try_step','try_step',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,'system','2022-04-13 08:30:00','system','2022-04-13 08:30:00','f19b54a8-94e7-474f-aa76-545996336b01'),(6,1,1,3,'Try step 3','step',NULL,'try_step','try_step',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,1,'system','2022-04-13 08:30:00','system','2022-04-13 08:30:00','6ab05f52-1028-487f-b86c-05b51c2ce0ab'),(7,1,1,5,'Try text in stepper','text','text_2','text_2','text_2','Try text in stepper placeholder',NULL,NULL,'Try text in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','45e94335-5ceb-48e5-80e1-cf71a01c86a7'),(8,1,1,5,'Try url in stepper 2','url','url_1','url_1','url_1','Try url in stepper placeholder',NULL,NULL,'Try url in stepper description',NULL,'{\"pattern\":\"^(https?:\\\\/\\\\/(?:www\\\\.|(?!www))[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\\\\.[^\\\\s]{2,}|www\\\\.[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\\\\.[^\\\\s]{2,}|https?:\\\\/\\\\/(?:www\\\\.|(?!www))[a-zA-Z0-9]+\\\\.[^\\\\s]{2,}|www\\\\.[a-zA-Z0-9]+\\\\.[^\\\\s]{2,})\"}','Fill in the field with valid url (Example: https://www.dynamic-form.local)',NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','bf0a8b79-fc5e-41bd-86e7-5738a4250923'),(9,1,1,5,'Try select in stepper 2','select','select_2','select_2','select_2','Try select in stepper placeholder','master-publication_status',NULL,'Try select in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','665b4ed0-98b5-41a9-9e48-8e749d23746c'),(10,1,1,6,'Try select in stepper 3','select','select_3','select_3','select_3','Try select in stepper placeholder','master-publication_status',NULL,'Try select in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','91752469-462f-46ae-99ed-4e5d10e1a8cb'),(11,1,1,6,'Try select in stepper 4','select','select_4','select_4','select_4','Try select in stepper placeholder','master-publication_status',NULL,'Try select in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','01103034-b518-4331-85de-39a34909a4e2'),(12,1,1,6,'Try select in stepper 5','select','select_5','select_5','select_5','Try select in stepper placeholder','master-publication_status',NULL,'Try select in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','00296c1d-8a43-488f-b2ee-168a6bb35f5c'),(13,1,1,6,'Try number','number','number_1','number_1','number_1','Try number placeholder',NULL,NULL,'Try number description',NULL,'{\"min\":1,\"pattern\":\"^[0-9]*$\"}','Fill in the field with numbers greater than 0',NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','6bfc3e0e-5fb0-482d-9521-5cc0132fd877'),(14,1,1,NULL,'URL of dynamic-form blog','url','url_2','url_2','url_2','Try url placeholder',NULL,NULL,'Try url description',NULL,'{\"pattern\":\"^(https?:\\\\/\\\\/(?:www\\\\.|(?!www))[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\\\\.[^\\\\s]{2,}|www\\\\.[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\\\\.[^\\\\s]{2,}|https?:\\\\/\\\\/(?:www\\\\.|(?!www))[a-zA-Z0-9]+\\\\.[^\\\\s]{2,}|www\\\\.[a-zA-Z0-9]+\\\\.[^\\\\s]{2,})\"}','Fill in the field with valid url (Example: https://www.dynamic-form.local)',NULL,NULL,1,1,'system','2022-04-13 08:30:00','system','2022-04-13 08:30:00','88d8ffef-aa51-4337-b9fe-986249994710'),(15,1,1,NULL,'Number of position','number','number_2','number_2','number_2','Try number placeholder',NULL,NULL,'Try number description',NULL,'{\"min\":0,\"pattern\":\"^[0-9]*$\"}','Fill in the field with numbers minimal 0',NULL,NULL,1,1,'system','2022-04-13 08:30:00','system','2022-04-13 08:30:00','650fde7c-c52e-4d16-8c1b-6fea9e50dc4e'),(16,1,1,NULL,'Try accordion','accordion',NULL,'try_accordion','try_accordion',NULL,NULL,'{\"orientation\":\"horizontal\",\"linear\":true}','',NULL,NULL,NULL,NULL,NULL,0,1,'system','2022-04-13 08:30:00','system','2022-04-13 08:30:00','6b7dba25-0beb-4733-a835-b3898d6bb26e'),(17,1,1,16,'Try panel 1','panel',NULL,'try_panel_1','try_panel_1',NULL,NULL,'{\"panel_description\":{\"mat_icon\":\"signal_cellular_alt\"}}','Panel 1 description',NULL,NULL,NULL,NULL,NULL,0,1,'system','2022-04-13 08:30:00','system','2022-04-13 08:30:00','1bd26b53-2423-4196-915a-e07d598a400c'),(18,1,1,16,'Try panel 2','panel',NULL,'try_panel_2','try_panel_2',NULL,NULL,'{\"panel_description\":{\"mat_icon\":\"add_comment\"}}','Panel 2 description',NULL,NULL,NULL,NULL,NULL,0,1,'system','2022-04-13 08:30:00','system','2022-04-13 08:30:00','5c3d1fba-07e9-4f62-b40a-6f0cf3ca3c47'),(19,1,1,16,'Try panel 3','panel',NULL,'try_panel_3','try_panel_3',NULL,NULL,'{\"panel_description\":{\"mat_icon\":\"bedtime\"}}','Panel 3 description',NULL,NULL,NULL,NULL,NULL,0,1,'system','2022-04-13 08:30:00','system','2022-04-13 08:30:00','0bf8eaea-0b41-421f-90df-7cab6820bb03'),(20,1,1,17,'Try text in accordion','text','text_3','text_3','text_3','Try text in stepper placeholder',NULL,NULL,'Try text in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','97f24305-32fd-4c5c-9b06-3e06685b9e9d'),(21,1,1,17,'Try url in accordion','url','url_3','url_3','url_3','Try url in stepper placeholder',NULL,NULL,'Try url in stepper description',NULL,'{\"pattern\":\"^(https?:\\\\/\\\\/(?:www\\\\.|(?!www))[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\\\\.[^\\\\s]{2,}|www\\\\.[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\\\\.[^\\\\s]{2,}|https?:\\\\/\\\\/(?:www\\\\.|(?!www))[a-zA-Z0-9]+\\\\.[^\\\\s]{2,}|www\\\\.[a-zA-Z0-9]+\\\\.[^\\\\s]{2,})\"}','Fill in the field with valid url (Example: https://www.dynamic-form.local)',NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','c6fd9952-a579-4b77-80af-e77dd243df6d'),(22,1,1,18,'Try select 6 in accordion','select','select_6','select_6','select_6','Try select in stepper placeholder','master-publication_status',NULL,'Try select in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','ba098daa-b583-4585-be64-75aecedebebd'),(23,1,1,18,'Try select 7 in accordion','select','select_7','select_7','select_7','Try select in stepper placeholder','master-publication_status',NULL,'Try select in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','ac582053-7102-4d38-9e4e-4f2e147ea10c'),(24,1,1,19,'Try select 8 in accordion','select','select_8','select_8','select_8','Try select in stepper placeholder','master-publication_status',NULL,'Try select in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','e5d4d83e-7f44-4b27-b5eb-ed6a8606221f'),(25,1,1,19,'Try select 9 in accordion','select','select_9','select_9','select_9','Try select in stepper placeholder','master-publication_status',NULL,'Try select in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','e3353704-c52f-4fd2-a98f-f9de41256575'),(26,1,1,17,'Try number 3 in accordion','number','number_3','number_3','number_3','Try number placeholder',NULL,NULL,'Try number description',NULL,'{\"min\":1,\"pattern\":\"^[0-9]*$\"}','Fill in the field with numbers greater than 0',NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','fdd068c9-8358-4138-8ad3-11ad46928487'),(27,1,1,5,'Try date in stepper','date','date_1','date_1','date_1','Try date in stepper placeholder',NULL,NULL,'Try date in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','0c88833c-e6ed-4173-8218-610edaf00f64'),(28,1,1,5,'Try month in stepper','month','month_1','month_1','month_1','Try month in stepper placeholder',NULL,NULL,'Try month in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','824e276c-1329-4287-b481-7fa764aebd65'),(29,1,1,5,'Try year in stepper','year','year_1','year_1','year_1','Try year in stepper placeholder',NULL,NULL,'Try year in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','2cace5a0-039f-44cf-9b03-3ee572e874df'),(30,1,1,4,'Try owl date in stepper','owl-date','date_2','date_2','date_2','Try owl date in stepper placeholder',NULL,NULL,'Try owl date in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','ba9091e4-0c1f-4305-bf43-c1f269efc173'),(31,1,1,4,'Try owl month in stepper','owl-month','month_2','month_2','month_2','Try owl month in stepper placeholder',NULL,NULL,'Try owl month in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','53a9e993-6cbc-4c79-a7ba-a71d90750d0a'),(32,1,1,4,'Try owl year in stepper','owl-year','year_2','year_2','year_2','Try owl year in stepper placeholder',NULL,NULL,'Try owl year in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','11a72636-718f-47e3-b0b7-03fd7a89e684'),(33,1,1,4,'Try owl time in stepper','owl-time','time_1','time_1','time_1','Try owl time in stepper placeholder',NULL,NULL,'Try owl time in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','14514578-58b8-4afb-b15b-9b91a57f1732'),(34,1,1,4,'Try owl date time in stepper','owl-datetime','datetime_1','datetime_1','datetime_1','Try owl date time in stepper placeholder',NULL,NULL,'Try owl date time in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','191067ab-71e0-4826-a342-c3ef7f49c0e5'),(35,1,1,4,'Try owl date range in stepper','owl-daterange','daterange_1','daterange_1','daterange_1','Try owl date range in stepper placeholder','',NULL,'Try owl date range in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','ac86e1ea-aaa7-4998-a959-ea681c8aa9c2'),(36,1,1,4,'Try owl time range in stepper','owl-timerange','timerange_1','timerange_1','timerange_1','Try owl time range in stepper placeholder','',NULL,'Try owl time range in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','b2a39665-5d93-4fa6-b343-bbbf0773cd48'),(37,1,1,4,'Try owl date time range in stepper','owl-datetimerange','datetimerange_1','datetimerange_1','datetimerange_1','Try owl date time range in stepper placeholder','',NULL,'Try owl date time range in stepper description',NULL,NULL,NULL,NULL,NULL,1,1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','7afb5ab5-6e39-4c5e-a2f4-75949ff511b3');
...
INSERT INTO `publication_form_version` VALUES (1,1,'Book 1 v1','BOK1-V1',1,'system','2022-04-09 21:43:00','system','2022-04-09 21:43:00','d152c092-1141-4640-846d-24a6ef91b646'),(2,2,'Book 2 v1','BOK1-V2',1,'system','2022-04-10 20:18:00','system','2022-04-10 20:18:00','4798da8b-c6a3-4619-b1f1-1770799918c3'),(3,3,'Journal 1 v1','JUR1-V2',1,'system','2022-04-10 20:18:00','system','2022-04-10 20:18:00','b34ca836-0b7a-420d-88b9-e463cf6572da');
...
-- Dump completed on 2022-04-30 20:22:29

...
class PublicationFormQueryController extends AbstractController
{
    ...
    #[Route('/api/v1/configurations/publication-form', name: 'app_v1_configurations_publication_form_query')]
    ...
    #[Route('/api/v1/configurations/publication-forms', methods: ['GET'], name: 'app_v1_configurations_publication_form_get_all')]
